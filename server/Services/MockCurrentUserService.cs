...
public sealed class MockCurrentUserService(IHttpContextAccessor httpContextAccessor) : ICurrentUserService
{
    ...
    {
        ["prototype-host-requester"] = ("Alex Morgan", "alex.morgan@rrvms.com", "HOST_REQUESTER"),
        ["prototype-export-control"] = ("Priya Shah", "priya.shah@rrvms.com", "EXPORT_CONTROL"),
        ["prototype-reception"] = ("Michael Brown", "michael.brown@rrvms.com", "RECEPTION"),
    };
