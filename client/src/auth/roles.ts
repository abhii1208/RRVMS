...
export const mockUsers: MockUser[] = [
  { id: 'prototype-host-requester', name: 'Alex Morgan', email: 'alex.morgan@rrvms.com', role: 'HOST_REQUESTER', initials: 'AM' },
  { id: 'prototype-export-control', name: 'Priya Shah', email: 'priya.shah@rrvms.com', role: 'EXPORT_CONTROL', initials: 'PS' },
  { id: 'prototype-reception', name: 'Michael Brown', email: 'michael.brown@rrvms.com', role: 'RECEPTION', initials: 'MB' },
]
